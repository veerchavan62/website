...
export default function CtaBanner() {
  return (
    <section className="relative bg-neutral-950 py-32 md:py-40 overflow-hidden">
      {/* Premium background */}
      ...
      {/* Ambient glows */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[600px] bg-blue-500/8 rounded-full blur-[150px]" />
      <div className="absolute top-0 left-0 w-[400px] h-[400px] bg-neutral-500/5 rounded-full blur-[100px]" />
        ...
        >
          ...
          <div className="mt-12 flex flex-col sm:flex-row items-center justify-center gap-5">
            ...
            <a
              ...
              className="group inline-flex items-center gap-2.5 px-8 py-4 rounded-full text-sm font-medium text-white border border-neutral-700 hover:border-neutral-600 hover:bg-white/5 transition-all duration-300"
            >
