...
export default function HeroSection() {
  return (
    <section className="relative min-h-screen flex items-center bg-neutral-900 overflow-hidden">
      ...
      <div className="relative section-container w-full py-28 md:py-36 lg:py-40">
        <div className="grid lg:grid-cols-2 gap-20 lg:gap-28 items-center">
          ...
          >
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full border border-neutral-700 bg-neutral-800/50 mb-8"
            >
            ...
            {/* Headline */}
            <h1 className="text-5xl md:text-5xl lg:text-5xl font-semibold text-white leading-[1.15] tracking-tight">
              Premium Workspace{' '}
            ...
            {/* Subheadline */}
            <p className="mt-7 text-base text-neutral-400 leading-relaxed max-w-xl mx-auto lg:mx-0">
            ...
            <div className="mt-9 flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start">
              <a
                href="#contact"
                className="inline-flex items-center gap-2 px-6 py-3 bg-white text-neutral-900 rounded-lg text-sm font-semibold hover:bg-neutral-100 transition-colors"
              >
                Get Free Quote
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-6 py-3 border border-neutral-600 text-white rounded-lg text-sm font-medium hover:bg-white/5 transition-colors"
              >
        ...
        <motion.div
          ...
          className="mt-24 pt-14 border-t border-neutral-800"
        >
          <div className="flex flex-wrap items-center justify-center lg:justify-start gap-16 md:gap-24">
            {stats.map((stat, i) => (
