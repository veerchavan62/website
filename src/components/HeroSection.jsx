...
export default function HeroSection() {
  return (
    <section className="relative min-h-screen flex items-center bg-neutral-950 overflow-hidden">
      ...
      <div className="relative section-container w-full pt-40 pb-32 md:pt-52 md:pb-40 lg:pt-64 lg:pb-48">
        <div className="grid lg:grid-cols-2 gap-20 lg:gap-40 items-center">
          ...
          >
            ...
            <motion.h1 
              ...
              className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-light text-white leading-[1.05] tracking-[-0.03em]"
            >
              Premium{' '}
            ...
            <motion.p 
              ...
              className="mt-8 text-base text-neutral-400 leading-relaxed max-w-2xl lg:max-w-xl"
            >
              Authorized OEM dealer for Wipro, Godrej Interio, and enterprise infrastructure leaders. Delivering world-class workspace solutions from strategic planning through complete implementation.
            </motion.p>
            ...
            <motion.div 
              ...
              className="mt-12 flex flex-col sm:flex-row items-start gap-4 lg:justify-start"
            >
              <a
                href="#contact"
                className="group inline-flex items-center gap-3 px-8 py-3 bg-white text-neutral-900 rounded-lg text-sm font-medium hover:bg-neutral-50 transition-all duration-300 premium-shadow hover:shadow-[0_0_0_1px_rgba(255,255,255,0.2),0_8px_32px_rgba(0,0,0,0.15)]"
              >
              ...
              <a
                ...
                className="group inline-flex items-center gap-3 px-8 py-3 rounded-lg text-sm font-medium text-white/90 border border-white/10 hover:border-white/20 hover:bg-white/5 backdrop-blur-sm transition-all duration-300"
              >
